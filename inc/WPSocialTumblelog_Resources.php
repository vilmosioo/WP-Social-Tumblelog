...
class WPSocialTumblelog_Resources{
	...
	const FIELDS_MANDATORY = 'All fields mandatory';
	const INVALID_SOCIAL = 'Invalid social network. Can only connect to Twitter or Github.';
	const AJAX_ACTION_ADD_FEED = 'wp_social_tumblelog_add_feed';
	const AJAX_ACTION_REMOVE_FEED = 'wp_social_tumblelog_remove_feed';
	const AJAX_ACTION_CONNECT = 'wp_social_tumblelog_connect';
